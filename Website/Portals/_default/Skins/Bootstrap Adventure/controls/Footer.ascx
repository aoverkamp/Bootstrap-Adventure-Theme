    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md">
                <small class="d-block mb-3 text-muted site-copyright"><dnn:COPYRIGHT runat="server" /></small>
            </div>
            ...
            <ul>
                ...
                <li>
                    <a href="https://github.com/">
                        <svg class="icon icon__svg icon__social icon__github">
                            <use xlink:href="#icon__github" />
                        </svg>
                    </a>
                </li>
            </ul>
