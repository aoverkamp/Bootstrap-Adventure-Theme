...
<div class="bootstrap-adventure bootstrap-adventure__home">
    ...
    <main role="main" class="site--main">
        ...
        <div class="container">
            ...
            <div class="row">
                <div runat="server" id="ThreeCol1" class="col-sm pane pane__three-col-1"></div>
                <div runat="server" id="ThreeCol2" class="col-sm pane pane__three-col-2"></div>
                <div runat="server" id="ThreeCol3" class="col-sm pane pane__three-col-3"></div>
            </div>
